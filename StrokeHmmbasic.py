...
class HMM:
    ...
    def label( self, data ):
        ...
        for obs in data[1:]:
            dposs = [
                prevDprob + math.log(transitionMatrix['drawing']['drawing'] * emissionMatrix['drawing']['length'][obs['length']]),
                prevLprob + math.log(transitionMatrix['text']['drawing'] * emissionMatrix['drawing']['length'][obs['length']])
            ]
            dbest = argmax(dposs)
            if dbest == 0:
                nextdpath = dpath[:]
            ...
            lposs = [
                prevDprob + math.log(transitionMatrix['drawing']['text'] * emissionMatrix['text']['length'][obs['length']]),
                prevLprob + math.log(transitionMatrix['text']['text'] * emissionMatrix['text']['length'][obs['length']])
            ]
